...
namespace XamFormsMvvmAndRESTServices
{
    internal partial class Setup : IServiceOperations<XamarinMVVMSampleWebAPIService>, ISetup
    {
        ...
        /// </param>
        internal Setup(XamarinMVVMSampleWebAPIService client)
        {
            this._client = client;
        }
        ...
        /// Cancellation token.
        /// </param>
        public async Task<HttpOperationResponse<string>> GetSetupWithOperationResponseAsync(CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // Tracing
            ...
            if (shouldTrace)
            {
                ...
                ServiceClientTracing.Enter(invocationId, this, "GetSetupAsync", tracingParameters);
            }
