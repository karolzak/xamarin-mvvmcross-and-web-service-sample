...
namespace XamMvvmAndWebServices.Droid.Views
{
    ...
    public class CustomersView : MvxActivity
    {
        ...
        public override bool OnOptionsItemSelected(IMenuItem item)
        {
            switch (item.ItemId)
            {
                ...
                case Resource.Id.menu_create:
                    ...
                    (ViewModel as CustomersViewModel).AddCommand.Execute(null);
                    return true;
        ...
        public override bool OnContextItemSelected(IMenuItem item)
        {
            ...
            (ViewModel as CustomersViewModel).EditCommand.Execute((info.TargetView as MvvmCross.Binding.Droid.Views.MvxListItemView).DataContext);
