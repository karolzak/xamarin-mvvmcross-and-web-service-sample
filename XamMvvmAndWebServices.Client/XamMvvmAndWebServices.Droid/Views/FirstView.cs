    ...
    public class FirstView : MvxActivity
    {
        ...
        public override bool OnOptionsItemSelected(IMenuItem item)
        {
            switch (item.ItemId)
            {
                ...
                case Resource.Id.menu_create:
                    ...
                    (ViewModel as FirstViewModel).AddCommand.Execute(null);
                    return true;
        ...
        public override bool OnContextItemSelected(IMenuItem item)
        {
            ...
            var menuItemName = menuItems[menuItemIndex];
             (ViewModel as FirstViewModel).EditCommand.Execute((info.TargetView as MvvmCross.Binding.Droid.Views.MvxListItemView).DataContext);
